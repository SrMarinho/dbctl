...
troca de branch (ver Caso 3.1 na seção 7). Segue o mesmo contrato dos outros `commands/*.py`: retorna
dados, nunca imprime.
...
## 13. Detecção automática de módulos alterados (plano: `docs/plans/auto-detect-changed-modules.md`)
